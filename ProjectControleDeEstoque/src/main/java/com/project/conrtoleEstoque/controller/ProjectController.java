...
public class ProjectController {
	...
	@GetMapping
	public ResponseEntity<Page<ProductDtoRequest>> findAll(Pageable pageable) {
		Page<ProductDtoRequest> pages = productService.findAll(pageable);
		return ResponseEntity.ok(pages);
	}
	
	@GetMapping("/id={id}")
	public ResponseEntity<ProductDtoRequest> findById(@PathVariable Long id) {
		return productService.findById(id);
	}
	
	@GetMapping("/{name}")
	public ResponseEntity<List<ProductDtoRequest>> findByName(@PathVariable String name) {
